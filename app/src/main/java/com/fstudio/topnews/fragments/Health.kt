...
class Health : Fragment() {
    ...
    override fun onCreateView(
        ...
        swipeRefreshLayout = view.findViewById(R.id.healthRefreshLayout)
        swipeRefreshLayout.setOnRefreshListener{
            modelClassArrayList = ArrayList()
            findNews()
        }

        //  progressBarNews = view.findViewById(R.id.progressBarNewsHealth);
        //  progressBarNews.setMax(100); //Progress bar
        shimmerFrameLayout = view.findViewById(R.id.shimmerLayoutHealth)
        shimmerFrameLayout.startShimmer()
        rvAll = view.findViewById(R.id.rvHealth)
    ...
    private fun findNews() {
        NewsApiUtilities.getApiInterface().categoryNews(COUNTRY_NAME, "health")
