...
class Entertainment : Fragment() {
   ...
   lateinit var shimmerFrameLayout: ShimmerFrameLayout
    override fun onCreateView(
        ...
        swipeRefreshLayout = view.findViewById(R.id.entertainmentRefreshLayout)
        swipeRefreshLayout.setOnRefreshListener {
            modelClassArrayList = ArrayList()
            findNews()
        }

        //   progressBarNews = view.findViewById(R.id.progressBarNewsEntertainment);
        //   progressBarNews.setMax(100); //Progress bar
        shimmerFrameLayout = view.findViewById(R.id.shimmerLayoutEntertainment)
        shimmerFrameLayout.startShimmer()
        rvAll = view.findViewById(R.id.rvEntertainment)
    ...
    private fun findNews() {
        NewsApiUtilities.getApiInterface().categoryNews(COUNTRY_NAME, "entertainment")
