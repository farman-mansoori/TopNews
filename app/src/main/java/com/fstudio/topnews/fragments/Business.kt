...
class Business : Fragment() {
    ...
    override fun onCreateView(
        ...
        swipeRefreshLayout = view.findViewById(R.id.businessRefreshLayout)
        ...
        //  progressBarNews = view.findViewById(R.id.progressBarNewsBusiness);
        //  progressBarNews.setMax(100); //Progress bar
        shimmerFrameLayout = view.findViewById(R.id.shimmerLayoutBusiness)
        shimmerFrameLayout.startShimmer()
        rvAll = view.findViewById(R.id.rvBusiness)
        rvAll.layoutManager = LinearLayoutManager(context)
        modelClassArrayList = ArrayList()
        adapter = NewsAdapter(this.requireContext(), modelClassArrayList!!)
    ...
    private fun findNews() {
        NewsApiUtilities.getApiInterface().categoryNews(COUNTRY_NAME, "business")
