...
class Sports : Fragment() {
    ...
    override fun onCreateView(
        ...
        swipeRefreshLayout = view.findViewById(R.id.sportsRefreshLayout)
        ...
        rvAll = view.findViewById(R.id.rvSports)
    ...
    private fun findNews() {
        NewsApiUtilities.getApiInterface().categoryNews(COUNTRY_NAME, "sports")
