...
class Technology : Fragment() {
    ...
    override fun onCreateView(
        ...
        swipeRefreshLayout = view.findViewById(R.id.technologyRefreshLayout)
        swipeRefreshLayout.setOnRefreshListener {
            modelClassArrayList = ArrayList()
            findNews()
        }

        //  progressBarNews = view.findViewById(R.id.progressBarNewsTechnology);
        //  progressBarNews.setMax(100); //Progress bar
        shimmerFrameLayout = view.findViewById(R.id.shimmerLayoutTechnology)
        shimmerFrameLayout.startShimmer()
        rvAll = view.findViewById(R.id.rvTechnology)
    ...
    private fun findNews() {
        NewsApiUtilities.getApiInterface().categoryNews(COUNTRY_NAME, "technology")
